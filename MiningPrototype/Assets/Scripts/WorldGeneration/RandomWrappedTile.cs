...
namespace UnityEngine.Tilemaps
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "RandomWrappedTile")]
    public class RandomWrappedTile : Tile
    {
        const int TILEMAP_WRAPX = 100;
        /// <summary>
        ...
        public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData)
        {
            ...
            {
                long hash = (position.x + TILEMAP_WRAPX) % TILEMAP_WRAPX;
...
#if UNITY_EDITOR
    [CustomEditor(typeof(RandomWrappedTile))]
    public class RandomWrappedTileEditor : Editor
    {
        private SerializedProperty m_Color;
        private SerializedProperty m_ColliderType;

        private RandomWrappedTile tile { get { return (target as RandomWrappedTile); } }
